 ...
 * Use the [f_procesion_juego_adivinar_Jesus.newInstance] factory method to
...
class f_procesion_juego_adivinar_Jesus : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment f_procesion_juego_adivinar_Jesus.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            f_procesion_juego_adivinar_Jesus().apply {
